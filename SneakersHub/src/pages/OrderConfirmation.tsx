...
const OrderConfirmation = () => {
  ...
  if (!latestOrder) {
    return (
      <div className="min-h-screen bg-background">
        <Navbar />
        <div className="page-safe section-padding max-w-4xl mx-auto flex flex-col items-center justify-center min-h-[60vh]">
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="page-safe section-padding max-w-3xl mx-auto pb-20">

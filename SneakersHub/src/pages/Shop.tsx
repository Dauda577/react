      ...
      <div className="section-padding max-w-7xl mx-auto pb-20"
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-6">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold tracking-tight">
            {category === "All" ? "All Sneakers" : category}
          </h1>
        ...
        {/* Category pills — always visible, synced to URL */}
        ...
        {loading ? (
          ...
          <div className="text-center py-20 border border-dashed border-border rounded-2xl">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              {search ? `No results for "${search}"` : `No ${category === "All" ? "" : category + " "}sneakers listed yet.`}
            </p>
            {(search || category !== "All") && (

...
const MessagesInbox = () => {
  const { conversations, totalUnread, deleteConversation } = useMessages();
  const { user } = useAuth();
            ...
            >
              ...
              >
                ...
                <div className="relative flex-shrink-0">
                  ...
                  {conv.unread_count > 0 && (
                    <div
                      className="absolute -top-0.5 -right-0.5 w-4 h-4 rounded-full bg-primary text-primary-foreground
              ...
              <button
                ...
                className="absolute top-2 right-2 opacity-0 group-hover:opacity-100
                  transition-opacity bg-destructive/10 hover:bg-destructive/20
                  text-destructive p-1.5 rounded-lg"
              >
